...
export const QA_KNOWN_STATES: QaKnownState[] = [
  ...
  knownState({ id: 'NOTI-INVITER-WATCH', label: '초대자 반복 활동 WATCH 알림', area: '알림', lifecycle: 'production', coverage: 'missing', kind: 'screen', priority: 'high', userVisible: true, sourcePaths: [notifications, notificationHistory], scenarioIds: [] }),
