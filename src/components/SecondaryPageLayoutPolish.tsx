export function SecondaryPageLayoutPolish() {
  return (
    <style jsx global>{`
      ...
      /* Numeric typography only. Rank positioning and movement geometry are
       * owned by leaderboard-podium-layout-guard.css; podium artwork is owned
       * only by the approved podium CSS files. */
      ...
      /* Address Picasso is rendered immediately. A resolved VET Domain image
       * may replace it later, but the avatar host itself is never an empty
       * loading placeholder. */
