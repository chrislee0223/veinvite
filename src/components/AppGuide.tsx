...
const AppNetworkCanaryV74 = dynamic(
  () => import('./AppNetworkCanaryV74').then((module) => module.AppNetworkCanaryV74),
  { ssr: false },
);
  ...
  if (wallet?.toLowerCase() === NETWORK_CANARY_WALLET) {
    return (
      <>
        ...
        <AppNetworkCanaryV74 key={wallet.toLowerCase()} locale={locale} />
      </>
    );
  }
