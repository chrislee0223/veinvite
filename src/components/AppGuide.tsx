  ...
  return (
    <section className="guidePage">
      ...
      <section className="eligibilityCard">
        ...
        <Definition title={t.countTitle} description={t.countDescription} icon="✓" />
      </section>
      ...
      <style jsx>{`
        ...
        h1 { margin: 8px 0 0; font-size: clamp(2rem, 8vw, 2.75rem); line-height: 1.05; letter-spacing: -.05em; text-wrap: balance; overflow-wrap: anywhere; }
        header p { margin: 12px 0 0; color: #aaa69d; font-size: .9rem; line-height: 1.62; overflow-wrap: anywhere; }
        ...
        .steps p { margin: 5px 0 0; color: #96928a; font-size: .76rem; line-height: 1.55; overflow-wrap: anywhere; }
...
function Definition({ title, description, icon }: { title: string; description: string; icon: string }) {
  return (
    <div className="definition">
      ...
      <style jsx>{`
        ...
        p { margin: 4px 0 0; color: #8f8b83; font-size: .73rem; line-height: 1.5; overflow-wrap: anywhere; }
      `}</style>
    </div>
  );
}
