...
const COPY: Record<Locale, RewardEstimateCopy> = {
  ...
  hi: {
    ...
    title: 'अगर आप अभी जुड़ें',
    perInvite: 'हर सफल आमंत्रण पर',
    expectedParticipants: 'अनुमानित इनाम पाने वाले',
    basisRound: (round) => `राउंड ${round} के आधार पर`,
    disclaimer: 'यह हाल की VeInvite allocation और मौजूदा भागीदारी के आधार पर अनुमान है। वास्तविक इनाम बदल सकता है और इसकी गारंटी नहीं है।',
    pendingTitle: 'अनुमान जल्द उपलब्ध होगा',
    pendingDescription: 'VeInvite को पहली वास्तविक B3TR allocation मिलने के बाद अनुमानित इनाम अपने-आप दिखाई देगा।',
    unavailable: 'फिलहाल इनाम का अनुमान उपलब्ध नहीं है।',
  },
  es: {
    eyebrow: 'RECOMPENSA ESTIMADA',
    title: 'Si participas ahora',
    perInvite: 'Por invitación completada',
    expectedParticipants: 'Beneficiarios estimados',
  ...
  ja: {
    ...
    pendingTitle: '予測を準備中',
    pendingDescription: 'VeInviteが最初の実際のB3TR配分を受け取ると、予想報酬が自動的に表示されます。',
    unavailable: '現在、予想報酬を計算できません。',
  },
  it: {
    eyebrow: 'RICOMPENSA STIMATA',
    title: 'Se partecipi ora',
    perInvite: 'Per invito completato',
    expectedParticipants: 'Beneficiari stimati',
    basisRound: (round) => `In base alla tornata ${round}`,
  ...
  tr: {
    ...
    title: 'Şimdi katılırsanız',
    perInvite: 'Başarılı davet başına',
    expectedParticipants: 'Tahmini ödül alıcısı',
  ...
  nl: {
    ...
    title: 'Als je nu meedoet',
    perInvite: 'Per succesvolle uitnodiging',
    expectedParticipants: 'Geschatte ontvangers',
  ...
  de: {
    ...
    title: 'Wenn du jetzt teilnimmst',
    perInvite: 'Pro erfolgreicher Einladung',
    expectedParticipants: 'Geschätzte Empfänger',
  ...
  fr: {
    ...
    title: 'Si vous participez maintenant',
    perInvite: 'Par invitation réussie',
    expectedParticipants: 'Bénéficiaires estimés',
    basisRound: (round) => `Basé sur le round ${round}`,
