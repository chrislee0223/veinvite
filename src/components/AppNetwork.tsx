  ...
  return (
    ...
    >
            ...
            {visibleGroups.map((group) => {
              ...
              return (
                <button
                  ...
                  data-workspace-draggable={editingLayout ? 'true' : undefined}
                >
                  <span className="groupGlyph" aria-hidden="true"><GroupsControlGlyph size={20} /></span>
      ...
      <style jsx>{`
        ...
        .groupNode{min-width:94px;max-width:136px;min-height:42px;padding:6px 8px;box-sizing:border-box;border:1.2px solid rgba(224,183,74,.62);border-radius:10px;background:linear-gradient(180deg,rgba(25,22,14,.97),rgba(16,15,11,.97));color:#d8b450;display:grid;grid-template-columns:24px minmax(0,1fr);column-gap:5px;row-gap:0;align-items:center;text-align:left;box-shadow:0 6px 20px rgba(0,0,0,.24);cursor:pointer;touch-action:none;user-select:none;-webkit-user-select:none;-webkit-touch-callout:none}.groupNode:hover,.groupNode.dropTarget{border-color:rgba(255,207,71,.84);box-shadow:0 0 0 3px rgba(244,183,40,.1),0 8px 26px rgba(0,0,0,.28)}.groupNode.dropTarget{background:linear-gradient(180deg,rgba(35,29,14,.99),rgba(20,17,10,.98));transform:translate(-50%,-50%) scale(1.035)}.groupNode.expanded{border-color:rgba(235,193,84,.72);background:linear-gradient(180deg,rgba(27,24,15,.98),rgba(17,16,12,.96))}.groupNode.expanded.dropTarget{border-color:rgba(255,207,71,.9);background:linear-gradient(180deg,rgba(38,31,14,.99),rgba(22,18,10,.98));box-shadow:0 0 0 3px rgba(244,183,40,.11),0 8px 26px rgba(0,0,0,.28)}.groupNode.created{animation:groupHubIn ${GROUP_HUB_IN_MS}ms cubic-bezier(.16,.82,.2,1) both}.groupNode .groupGlyph{grid-row:1/3}.groupNode strong{min-width:0;max-width:92px;font-size:.45rem;line-height:1.15;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.groupNode small{min-width:0;max-width:92px;color:#857655;font-size:.32rem;line-height:1.15;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.groupGlyph{width:24px;height:24px;display:grid;place-items:center;color:#d6ad49}.groupGlyph svg{display:block}
