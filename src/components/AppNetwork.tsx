  ...
  return (
    ...
    >
          ...
          <aside className={`profileCard${!focusIsRoot ? ' hasParentReturn' : ''}`} data-no-pan="true">
            ...
            <div className="profileIdentity">
              ...
              <div>
                ...
                <span className={`profileStatus status-${selectedStatus.toLowerCase()}`}>
      ...
      <style jsx>{`
        ...
        @media(max-width:560px){:global(.screen.networkScreen){padding-bottom:calc(72px + env(safe-area-inset-bottom))!important}:global(.screen.networkScreen .bottomNavigation){padding-bottom:env(safe-area-inset-bottom)!important}:global(.screen.networkScreen .bottomNavigation>div){min-height:60px!important;padding:4px!important;border-radius:20px!important}:global(.screen.networkScreen .bottomNavigation button){min-height:50px!important;padding:4px 3px!important;grid-template-rows:20px 12px!important;row-gap:3px!important}:global(.screen.networkScreen .bottomNavigation .navIcon),:global(.screen.networkScreen .bottomNavigation .navIcon svg){width:20px!important;height:20px!important}.networkCanvasPage{width:100%;border-radius:18px}.networkHeader{min-height:42px;padding:7px 9px}.networkHeader h1{font-size:.82rem}.summary{gap:2px 4px}.summary strong{font-size:.66rem}.summary span{font-size:.43rem}.networkUtilityRow{min-height:39px;padding:4px 6px;gap:4px}.searchWrap.open{max-width:min(168px,48vw)}.searchField input{font-size:16px}.compactControls{gap:3px}.layoutControls,.viewControls{gap:3px}.layoutControls>button,.groupMenuAnchor>button,.viewControls button,.viewControls .fitButton{height:29px;border-radius:8px}.groupsPanel,.groupBuilder{width:min(232px,calc(100vw - 28px))}.crumb{max-width:60px}.profileCard{top:auto;right:8px;bottom:8px;left:8px;width:auto}.profileCard.hasParentReturn{bottom:52px}.parentReturn{left:8px;bottom:8px}.personNode{min-width:0}.focusNode{min-width:0}}
