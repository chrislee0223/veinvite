  ...
  return (
    ...
    >
      ...
      <style jsx>{`
        ...
        .networkUtilityRow{position:relative;z-index:70;flex:0 0 auto;min-height:40px;padding:5px 7px;box-sizing:border-box;display:flex;align-items:center;justify-content:space-between;gap:5px;border-bottom:1px solid rgba(255,255,255,.05);background:rgba(11,11,9,.98)}
        ...
        .compactControls{flex:0 0 auto;margin-left:auto;display:flex;align-items:center;gap:4px}.networkCanvasPage[data-layout-editing='true'] .searchWrap{display:none}.networkStage{position:relative;flex:1 1 auto;min-height:0;height:auto;overflow:hidden;touch-action:none;overscroll-behavior:contain;background:radial-gradient(ellipse at 50% 50%,rgba(244,183,40,.036),transparent 36%),#080807;cursor:grab;user-select:none;-webkit-user-select:none}.networkStage:active{cursor:grabbing}.networkStage.layoutEditing{box-shadow:inset 0 0 0 1px rgba(244,183,40,.11)}
