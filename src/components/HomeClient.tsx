...
const COPY = {
  en: {
    ...
    inviteReadyDescription:
      'Share it with one friend. The first eligible person who joins will be connected to you.',
    friendJoinedBadge: 'FRIEND JOINED',
    friendJoinedTitle: 'Your friend joined',
    friendJoinedDescription:
      'They are completing the VeBetterDAO activation mission now.',
    reviewBadge: 'ACTIVATION CHECK',
    reviewTitle: 'Checking your friend’s activity',
    reviewDescription:
      'We are verifying the mission and reward eligibility.',
    completeBadge: 'MISSION COMPLETE',
    completeTitle: 'Invite completed',
    completeDescription:
      'Your friend finished activation. A new invite can now be unlocked.',
    ...
    rewardPending: 'Reward review in progress',
    rewardDescription:
      'The final amount is determined by the weekly participation result.',
    privacy: 'Privacy',
    terms: 'Terms',
  ...
  ko: {
    ...
    reviewTitle: '친구의 활동을 확인하고 있어요',
    reviewDescription:
      '미션 완료 여부와 추천 보상 자격을 확인하고 있습니다.',
    completeBadge: '미션 완료',
    completeTitle: '초대가 완료됐어요',
    completeDescription:
      '친구가 활성화를 마쳤어요. 다음 초대 기회를 준비할 수 있습니다.',
    shareInvite: '초대 공유하기',
    copyLink: '링크 복사',
    copied: '초대 링크를 복사했어요.',
    cancelInvite: '초대 취소',
    ...
    rewardPending: '보상 검토 진행 중',
    rewardDescription:
      '최종 보상은 주간 참여 결과에 따라 결정됩니다.',
    privacy: '개인정보처리방침',
    terms: '이용약관',
