...
export const HOME_COPY: Record<Locale, HomeCopy> = {
  en: {
    ...
    claimReward: 'Claim reward', claimingReward: 'Claiming…', rewardClaimed: 'Reward claim submitted',
    rewardClaimedDescription: 'Your reward is queued for the next funded reward round. No additional action is needed.',
  ...
  ko: {
    ...
    rewardLabel: '온보딩 상태', rewardLocked: '친구가 미션을 완료하면 확인돼요', rewardUnlocked: '온보딩 완료', locked: '잠김', unlocked: '해제',
    ...
    reviewBadge: '활성화 확인 중', reviewTitle: '마지막 단계를 확인하고 있어요', reviewDescription: '잠시만 기다려 주세요. 완료 전 마지막 확인이 필요해요.',
    ...
    cancelDescriptionWaiting: '현재 링크는 더 이상 작동하지 않고 초대 가능 횟수가 복구됩니다.', keepInvite: '초대 유지', confirmCancel: '초대 취소', cancelled: '초대가 취소됐어요. 새 초대를 만들 수 있어요.',
    ...
    rewardTitle: '추천 결과', rewardPending: '온보딩 확인 완료', rewardDescription: '현재 최종 보상 자격과 부정 활동 여부를 확인하고 있어요.',
    rewardClaimReady: '보상을 수령할 수 있어요', rewardClaimDescription: '추천 활동이 최종 검증을 통과했어요. 지금 수령 요청하면 다음 보상 라운드에 자동 반영됩니다.',
    claimReward: '보상 수령 요청', claimingReward: '요청하는 중…', rewardClaimed: '보상 수령 요청 완료', rewardClaimedDescription: '다음 보상 라운드 지급 대기열에 등록됐어요. 추가로 할 일은 없습니다.',
  ...
  es: {
    ...
    friendJoinedBadge: 'AMIGO INCORPORADO', friendJoinedTitle: 'Tu amigo ya se ha unido', friendJoinedDescription: 'Tu amigo está completando ahora las misiones de VeInvite.',
    ...
    noActive: 'No hay invitación activa', createLink: 'Invitar', linkCreated: 'Enlace listo', waitingForFriendStep: 'Esperando al amigo', friendJoins: 'Amigo incorporado', activation: 'Verificación final', waiting: 'Esperando al amigo', inProgress: 'En curso', checking: 'Comprobando', completed: 'Completado', codeLabel: 'Código de invitación',
    rewardTitle: 'Estado de la recomendación', rewardPending: 'Incorporación verificada', rewardDescription: 'Las comprobaciones finales de recompensa y prevención de abuso siguen en curso.', rewardClaimReady: 'Tu recompensa está lista para solicitar', rewardClaimDescription: 'La recomendación superó las comprobaciones finales. Solicítala ahora y se incluirá en la próxima ronda de recompensas con fondos.', claimReward: 'Solicitar recompensa', claimingReward: 'Solicitando…', rewardClaimed: 'Solicitud enviada', rewardClaimedDescription: 'Tu recompensa está en cola para la próxima ronda con fondos. No tienes que hacer nada más.', rewardAssigned: 'Preparando el pago', rewardAssignedDescription: 'Tu importe está reservado en una ronda de pago y espera la distribución final.', rewardPaid: 'Recompensa pagada', rewardPaidDescription: 'La recompensa en B3TR se verificó en cadena y se registró en tu historial.', rewardForfeited: 'Recompensa no aprobada', rewardForfeitedDescription: 'Esta recomendación no superó las comprobaciones finales. Tu espacio de invitación está disponible para otro amigo.', claimSuccess: 'Recompensa solicitada. Se incluirá en la próxima ronda con fondos.', claimError: 'No se pudo solicitar la recompensa.',
  ...
  ja: {
    ...
    inviteAvailable: '招待枠 1件 利用可能', inviteMission: 'クエスト 01', emptyTitle: '最初の友だちを招待しよう', emptyDescription: '招待リンクを作成して、新規または復帰ユーザーのVeInviteオンボーディングを手伝いましょう。',
    ...
    noActive: '進行中の招待なし', createLink: '招待', linkCreated: 'リンク準備完了', waitingForFriendStep: '友だち待ち', friendJoins: '友だち参加', activation: '最終確認', waiting: '友だち待ち', inProgress: '進行中', checking: '確認中', completed: '完了', codeLabel: '招待コード',
    rewardTitle: '招待報酬の状況', rewardPending: 'オンボーディング確認済み', rewardDescription: '最終的な報酬資格と不正利用チェックを行っています。', rewardClaimReady: '報酬を申請できます', rewardClaimDescription: '招待は最終確認を通過しました。今申請すると、次回の資金がある報酬ラウンドに自動で入ります。', claimReward: '報酬を申請', claimingReward: '申請中…', rewardClaimed: '報酬申請済み', rewardClaimedDescription: '次回の資金がある報酬ラウンドの待機列に入りました。追加の操作は不要です。', rewardAssigned: '報酬支払いを準備中', rewardAssignedDescription: '支払いラウンドで金額が確保され、最終送金を待っています。', rewardPaid: '報酬支払い完了', rewardPaidDescription: 'B3TR報酬の支払いがオンチェーンで確認され、履歴に記録されました。', rewardForfeited: '報酬対象外', rewardForfeitedDescription: 'この招待は最終報酬チェックを通過しませんでした。次の友だちを招待できます。', claimSuccess: '報酬を申請しました。次回の資金がある報酬ラウンドに入ります。', claimError: '報酬を申請できませんでした。',
