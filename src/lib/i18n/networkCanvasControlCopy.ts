...
export const NETWORK_CANVAS_CONTROL_COPY = {
  ...
  cs: { you: 'TY', branch: 'Síť', networkBelow: 'Síť pod profilem', expandBranch: 'Rozbalit síť', collapseBranch: 'Sbalit síť', close: 'Zavřít', centerNetwork: 'Vycentrovat síť', zoomIn: 'Přiblížit', zoomOut: 'Oddálit', previous: 'Předchozí', next: 'Další' },
