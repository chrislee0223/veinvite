...
export const REWARD_RECEIPT_COPY: Record<Locale, RewardReceiptCopy> = {
  ...
  ko: {
    ...
    description: '검증이 완료된 VeInvite 추천 보상이 이 지갑으로 지급됐어요.',
    ...
    acknowledge: '확인',
    acknowledging: '처리 중…',
    error: '보상 지급 내역을 확인 처리하지 못했어요. 다시 시도해 주세요.',
  },
  zh: {
    eyebrow: '推荐奖励已发放',
    title: 'B3TR 奖励已到账',
  ...
  es: {
    ...
    error: 'No pudimos marcar este comprobante de recompensa como visto. Inténtalo de nuevo.',
  },
  ja: {
    eyebrow: '招待報酬の支払い完了',
    title: 'B3TR報酬が届きました',
  ...
  nl: {
    ...
    error: 'Deze beloningsbon kon niet als bekeken worden gemarkeerd. Probeer het opnieuw.',
  },
  de: {
    ...
    error: 'Dieser Belohnungsbeleg konnte nicht als gesehen markiert werden. Bitte versuche es erneut.',
  },
  fr: {
    ...
    round: 'Manche VeBetterDAO',
    invite: 'Code d’invitation',
    transaction: 'Transaction',
    viewTransaction: 'Voir dans VeChain Explorer',
    acknowledge: 'Compris',
    acknowledging: 'Enregistrement…',
    error: 'Impossible de marquer ce reçu de récompense comme consulté. Veuillez réessayer.',
  },
};
