...
export const GUIDE_MISSION_STEP_COPY: Record<Locale, GuideMissionStepCopy> = {
  en: {
    ...
    description:
      'They receive B3TR rewards from three different VeBetterDAO dApps, convert B3TR to VOT3, and cast one Allocation Vote.',
  },
  ko: {
    title: '친구가 모든 미션 완료',
    description:
  ...
  es: {
    ...
    description:
      'Debe recibir recompensas B3TR en tres dApps distintas de VeBetterDAO, convertir B3TR a VOT3 y emitir un voto en Allocation Voting.',
  },
  ja: {
    title: '友だちがすべてのミッションを完了',
    description:
      '異なる3つのVeBetterDAO dAppでB3TR報酬を受け取り、B3TRをVOT3に変換し、Allocation Votingに1回参加します。',
  },
  it: {
  ...
  tr: {
    ...
    description:
      'Üç farklı VeBetterDAO dApp’inden B3TR ödülü almalı, B3TR’yi VOT3’e dönüştürmeli ve Allocation Voting’de bir kez oy kullanmalı.',
  },
  nl: {
    title: 'Je vriend voltooit alle missies',
    description:
      'Je vriend moet B3TR-beloningen ontvangen via drie verschillende VeBetterDAO-dApps, B3TR omzetten naar VOT3 en één keer stemmen via Allocation Voting.',
  },
  de: {
    title: 'Dein Freund schließt alle Missionen ab',
    description:
      'Er muss B3TR-Belohnungen aus drei verschiedenen VeBetterDAO-dApps erhalten, B3TR in VOT3 umwandeln und einmal im Allocation Voting abstimmen.',
  },
  fr: {
