...
is 'Public country arrival leaderboard. Country is attributed only from trusted activation or acquisition country evidence. Display language is never used to infer country. Users without trusted country evidence remain UNKNOWN with NEW/RETURNING breakdown fields.';
