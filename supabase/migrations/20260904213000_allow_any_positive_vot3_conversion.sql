...
begin
  ...
  -- Any positive amount qualifies. The raw-impact check below additionally
  -- proves that at least one dApp reward happened no later than conversion.
...
-- Keep the diagnostics view column shape stable for operator tooling, while
-- treating first_minimum_conversion_block as the first positive conversion.
