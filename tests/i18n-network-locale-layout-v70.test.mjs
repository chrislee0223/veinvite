...
const [source, rootIdentitySource, touchNavigationSource, guideSource, v69Source, controlCopySource] = await Promise.all([
...
test('V72 is the final Network canary touch layer and preserves the mature V71 to V69 chain', () => {
