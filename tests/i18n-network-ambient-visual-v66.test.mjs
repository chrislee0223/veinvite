...
const [visualSource, correctionSource, directDropSource, dragGhostSource, guideSource] = await Promise.all([
...
test('the special Network canary is wired through V69 to V68, V67 and V66', () => {
