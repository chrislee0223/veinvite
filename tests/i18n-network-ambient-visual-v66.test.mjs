...
const [visualSource, correctionSource, directDropSource, dragGhostSource, localeLayoutSource, rootIdentitySource, interactionOwnershipSource, guideSource] = await Promise.all([
