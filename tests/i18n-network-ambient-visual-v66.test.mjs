...
const [visualSource, correctionSource, directDropSource, dragGhostSource, localeLayoutSource, guideSource] = await Promise.all([
...
test('the special Network canary is wired through V70, V69, V68, V67 and V66', () => {
