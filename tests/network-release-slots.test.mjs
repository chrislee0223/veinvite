...
test('slot placement avoids live direct nodes and group hubs instead of using fixed overlapping coordinates', () => {
  ...
  assert.match(slotSource, /const nextOccupied = \[\.\.\.people, \.\.\.groupHubs\]/);
